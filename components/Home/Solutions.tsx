            ...
            <div className="lg:w-1/2 relative z-10 space-y-8">
              <div className="space-y-2">
                <h4 className="text-rose-600 font-black text-lg lg:text-xl tracking-[0.3em] uppercase animate-fade-in-up">
                  O Segredo da Lucratividade Ocupacional
                </h4>
              ...
              <h2 className="text-4xl lg:text-6xl font-black leading-[1.1] tracking-tighter" style={{ color: COLORS.primary }}>
                Blindagem Jurídica e <span className="text-rose-600">Alta Performance</span> para sua Empresa
              </h2>

              <p className="text-xl lg:text-2xl text-gray-600 leading-relaxed font-medium">
                Sua empresa está em risco agora mesmo? A falta de conformidade com a <strong>NR-17</strong> é a porta de entrada para passivos trabalhistas gigantescos. A ErghoPrev neutraliza esses riscos e transforma seu ambiente em um polo de produtividade.
              </p>
              ...
              <div className="flex flex-wrap gap-6 pt-4">
                ...
                >
                  ...
                  Eliminar Riscos e Multas Agora
                  <i className="fas fa-shield-alt text-sm group-hover:rotate-12 transition-transform"></i>
                </a>
                <a 
              ...
              <div className="pt-8 border-t border-gray-100 grid grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="text-sm font-bold text-gray-500 uppercase tracking-widest">Segurança Técnica</p>
                </div>
                <div>
                  <p className="text-3xl font-black text-rose-600">ZERO</p>
                  <p className="text-sm font-bold text-gray-500 uppercase tracking-widest">Preocupação Legal</p>
                </div>
              </div>
            </div>
              ...
              <div className="relative group perspective-1000">
                ...
                <div className="relative z-10 rounded-[4rem] overflow-hidden shadow-[0_50px_100px_rgba(0,0,0,0.15)] border-8 border-white transform transition-all duration-700 group-hover:rotate-2 group-hover:scale-[1.05]">
                  <img 
                    ...
                    alt="Consultoria Ergonômica Profissional" 
                  ...
                  <div className="absolute bottom-10 left-10 right-10 bg-white/95 backdrop-blur-md p-8 rounded-3xl shadow-2xl transform translate-y-4 group-hover:translate-y-0 transition-all duration-500">
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        <h5 className="font-black text-blue-950 text-xl">Adequação Imediata</h5>
                        <p className="text-gray-500 font-medium">Sua empresa em dia com o eSocial e PGR.</p>
                      </div>
                    </div>
                  </div>
                </div>
